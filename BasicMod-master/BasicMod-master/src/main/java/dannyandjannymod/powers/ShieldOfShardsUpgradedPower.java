...
public class ShieldOfShardsUpgradedPower extends AbstractPower implements BetterOnApplyPowerPower {
    public static final String POWER_ID = "ShieldOfShardsUpgradedPower";
    public static final String NAME;

    public ShieldOfShardsUpgradedPower(AbstractCreature owner, int amount) {
        this.name = NAME;
        this.ID = "ShieldOfShardsUpgradedPower";
        this.owner = owner;
        this.amount = amount;
    ...
    public boolean betterOnApplyPower(AbstractPower power, AbstractCreature target, AbstractCreature source) {
        ...
        if (target == p && power instanceof ThornsPower) {
            this.addToBot(new ApplyPowerAction(p, p, new MetallicizePower(p, amount)));
            this.flash();
        }
        return true;
    }
