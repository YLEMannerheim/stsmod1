...
public class GrowingPainsAction extends AbstractGameAction {

    private DamageInfo info;

    public GrowingPainsAction(AbstractCreature target, DamageInfo info) {
        this.info = info;
        ...
        if (this.shouldCancelAction()) {
            ...
            if (this.isDone) {
                ...
                if (this.target.lastDamageTaken > 0) {
                    ...
                    this.addToTop(new ApplyPowerAction(this.source, this.source, new CalciumPower(this.source, this.target.lastDamageTaken), this.target.lastDamageTaken));
