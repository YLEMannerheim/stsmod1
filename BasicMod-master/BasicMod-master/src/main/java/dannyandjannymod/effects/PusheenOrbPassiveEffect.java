...
package dannyandjannymod.effects;
...
public class PusheenOrbPassiveEffect extends AbstractGameEffect {
    ...
    public PusheenOrbPassiveEffect(float x, float y) {
        ...
        this.color = new Color(1.0F, MathUtils.random(0.7F, 0.9F), 1.0F, this.alpha);
