...
public class TiltedParticleEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float vY;
    ...
    public TiltedParticleEffect() {
        ...
        this.color = new Color(MathUtils.random(0.9F, 1.0F), 0.8F, MathUtils.random(0.3F, 0.4F), 0.0F);
